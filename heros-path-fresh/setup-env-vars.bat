...
eas env:create --scope project --name FIREBASE_AUTH_DOMAIN --value "***REMOVED***.firebaseapp.com" --type string
eas env:create --scope project --name FIREBASE_PROJECT_ID --value "***REMOVED***" --type string
eas env:create --scope project --name FIREBASE_STORAGE_BUCKET --value "***REMOVED***.firebasestorage.app" --type string
eas env:create --scope project --name FIREBASE_MESSAGING_SENDER_ID --value "***REMOVED***" --type string
eas env:create --scope project --name FIREBASE_APP_ID --value "1:***REMOVED***:web:eeee922280841a53da7982" --type string
